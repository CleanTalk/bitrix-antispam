	    		...
	    		if($result!==null)
	    		{
	    			...
	    			if(isset($result->data)&&isset($result->data->paid))
	    			{
	    				...
	    				if($last_status!=1&&$new_status==1)
	    				{
	    					...
	    					if(LANGUAGE_ID=='ru')
	    					{
	    						$review_message = "Íðàâèòñÿ àíòèñïàì îò CleanTalk? Ðàññêàæèòå äðóãèì îá ýòîì! <a target='_blank' href='http://marketplace.1c-bitrix.ru/solutions/cleantalk.antispam/#rating'>Îñòàâüòå îòçûâ â Bitrix.Marketplace</a>";
	    					}
	    					else
	    					{
