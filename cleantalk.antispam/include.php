...
require_once(dirname(__FILE__) . '/classes/phpFix.php');
...
require_once(dirname(__FILE__) . '/classes/CleantalkHelper.php');

// SFW class
require_once(dirname(__FILE__) . '/classes/CleantalkSFW.php');
