<?php
$MESS['CLEANTALK_BACK_LINK'] = 'Вернуться назад';
$MESS['CLEANTALK_EVENT']     = 'Автомодератор CleanTalk';
$MESS['CLEANTALK_MESSAGE']   = 'Сообщение';
$MESS['CLEANTALK_E_SERVER'] = 'Ошибка работы сервера CleanTalk';
